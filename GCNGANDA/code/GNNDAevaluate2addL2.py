...
for epoch in range(1, n_epochs + 1):
    ...
    total_loss = sup_loss + lambda_align * align_loss + l2_lambda * l2_reg
    ...
    if epoch % 10 == 0:
        ...
        with torch.no_grad():
            ...
            print(f"Epoch {epoch:03d}, Loss: {total_loss.item():.4f}, Sup Loss: {sup_loss.item():.4f}, "
                  f"Align Loss: {align_loss.item():.4f}, L2 Loss: {l2_lambda * l2_reg.item():.4f}, 训练集有标签准确率: {train_sup_acc:.4f}")
